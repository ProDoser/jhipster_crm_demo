...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "contactperson":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "country":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "postcode":"SAMPLE_TEXT", "street":"SAMPLE_TEXT", "comment":"SAMPLE_TEXT", "isprivate":null}""")).asJSON
            .check(status.is(201))
